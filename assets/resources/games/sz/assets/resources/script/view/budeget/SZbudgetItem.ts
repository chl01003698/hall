...
import SZpokersControl from "../game/SZpokersControl";


const {ccclass, property, menu} = cc._decorator;

@ccclass
@menu("sz/SZbudgetItem")
export default class SZbudgetItem extends cc.Component {
    @property(cc.Sprite) 
    head:cc.Sprite = null;
    ...
    updateView(data:any) {
        let userData = SZgameModel.getInstance().getPlayerData(data.uid);
