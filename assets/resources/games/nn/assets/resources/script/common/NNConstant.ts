...
export module NNConstant {

    export let gameName:string = "niuniu";
    ...
    export enum actionTag {
        ClockCountDown = 100,       //倒计时数字
        ClockCountDownOver = 101,   //倒计时结束
    }
