...
export class NNcreateTableMode extends HallBaseModel {
    ...
    private static instance:NNcreateTableMode;

    static getInstance():NNcreateTableMode{
        if (!this.instance){
            this.instance = new NNcreateTableMode();
        }
