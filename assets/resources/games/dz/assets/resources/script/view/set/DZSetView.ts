...
import { HallAudioManager, HallAudioStatus } from "../../../../../../../script/manager/HallAudioManager";
import { HallNetConfig } from "../../../../../../../script/net/HallNetConfig";
import {DZConstant} from "../../common/DZConstant";


export class DZSetView extends HallBaseView{
    ...
    shengmingCallback(){
        DZWebView.show("http://m.baidu.com",DZConstant.webType.statement);
    }
    proxyCallback(){
