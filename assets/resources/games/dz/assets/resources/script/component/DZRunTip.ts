...
import { DZHallModel } from "../view/hall/DZHallModel";
...
export default class NewClass extends cc.Component {
    ...
    start () {
        let tips = HallModel.getInstance().getTips();
        if(!tips){
            HallController.declaration(function(){
                this.tips = HallModel.getInstance().getTips();
                this.showTip();
            }.bind(this), "100010");
        }else{
            this.tips = tips;
